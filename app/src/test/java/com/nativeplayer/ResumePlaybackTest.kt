...
class ResumePlaybackTest {
    ...
    fun testGestureSettings() {
        ...
        assertEquals(com.nativeplayer.viewmodel.LongPressMode.WHOLE_SCREEN, viewModel.longPressMode.value)
        ...
        viewModel.setLongPressMode(com.nativeplayer.viewmodel.LongPressMode.SPLIT_SCREEN)
        assertEquals(com.nativeplayer.viewmodel.LongPressMode.SPLIT_SCREEN, viewModel.longPressMode.value)
