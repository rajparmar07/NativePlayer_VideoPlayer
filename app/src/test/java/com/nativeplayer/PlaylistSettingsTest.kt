...
import com.nativeplayer.viewmodel.PlaylistThumbnailPattern
...
class PlaylistSettingsTest {
    ...
    fun testCustomThumbnailPathUpdate() = runBlocking {
        ...
        val testImagePath = "/data/user/0/com.nativeplayer/files/playlist_covers/cover_test.jpg"
    ...
    fun testAddVideosToBookmarksAndPreventDuplicates() = runBlocking {
        ...
        val videos = listOf(
            com.nativeplayer.data.VideoModel(id = "1", title = "Movie 1", urlOrPath = "/path/to/movie1.mp4"),
            com.nativeplayer.data.VideoModel(id = "2", title = "Movie 2", urlOrPath = "/path/to/movie2.mp4")
        )
        ...
        // Remove one video
        val removeList = listOf(com.nativeplayer.data.VideoModel(id = "1", title = "Movie 1", urlOrPath = "/path/to/movie1.mp4"))
