...
import com.nativeplayer.data.AppDatabase
import com.nativeplayer.data.VideoRepository
import com.nativeplayer.ui.screens.*
import com.nativeplayer.ui.theme.MyApplicationTheme
import com.nativeplayer.viewmodel.VideoPlayerViewModel
import com.nativeplayer.viewmodel.VideoPlayerViewModelFactory
...
class MainActivity : ComponentActivity() {
    ...
    private val pipReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            intent?.action?.let { action ->
                when (action) {
                    "com.nativeplayer.ACTION_PLAY_PAUSE" -> {
                    ...
                    "com.nativeplayer.ACTION_NEXT" -> {
                        viewModel.playNext()
                    }
                    "com.nativeplayer.ACTION_PREV" -> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val filter = IntentFilter().apply {
            addAction("com.nativeplayer.ACTION_PLAY_PAUSE")
            addAction("com.nativeplayer.ACTION_NEXT")
            addAction("com.nativeplayer.ACTION_PREV")
        }
    ...
    private fun updatePipParams(isPlaying: Boolean) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            // Prev Action
            val prevIntent = Intent("com.nativeplayer.ACTION_PREV")
            ...
            // Play/Pause Action
            val playPauseIntent = Intent("com.nativeplayer.ACTION_PLAY_PAUSE")
            ...
            // Next Action
            val nextIntent = Intent("com.nativeplayer.ACTION_NEXT")
